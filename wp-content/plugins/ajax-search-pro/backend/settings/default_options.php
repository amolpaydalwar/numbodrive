...
// general
        ...
        'frontend_fields' => array(
            ...
            'unselected' => array('title', 'content', 'excerpt', 'comments'),
        ...
        'fe_sb_text' => 'Search!',
        'fe_sb_align' => 'center',
        'fe_sb_padding' => '8px 24px 8px 24px',
        'fe_sb_margin' => '0 0 0 0',
        ...
        'fe_sb_font' => 'font-weight:normal;font-family:Open Sans;color:rgb(255, 255, 255);font-size:15px;line-height:20px;text-shadow:0px 0px 0px rgba(255, 255, 255, 0);',
