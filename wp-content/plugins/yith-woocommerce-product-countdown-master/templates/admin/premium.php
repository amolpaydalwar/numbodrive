        ...
        <div class="premium-cta">
            <p>
                <?php echo sprintf( __( 'Upgrade to the %1$spremium version%2$s
                         of %1$sYITH WooCommerce Product Countdown%2$s to benefit from all features!', 'ywpc' ),
                    '<span class="highlight">', '</span>' ); ?>
            </p>
            <a href="<?php echo $this->get_premium_landing_uri(); ?>" target="_blank"
               class="premium-cta-button button btn">
                <?php echo sprintf( __( '%1$s UPGRADE %2$s %3$s to the premium version %2$s', 'ywpc' ),
    ...
    <div class="landing-container">
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e('Content','ywpc');?></h2>
            </div>
            <p>
                <?php
                echo sprintf( __('With the related option, you can choose what you want to show in the box of the plugin: %1$sthe countdown and/or the progressing sale bar%2$s. A general option suitable for all products.','ywpc'),'<b>','</b>');
                ?>
            </p>
        </div>
        <div class="col-1">
    ...
    <div class="landing-container">
        ...
        <div class="col-2">
            ...
            <p>
                ...
                Before or after the title, between the tabs, or after the related products: these are only some of the solutions the plugin offers.', 'ywpc' ), '<b>', '</b>');
                ?>
            </p>
        </div>
    </div>
        ...
        <div class="col-2">
            ...
            <p>
                ...
                choose if you want the product to be removed from the product catalogue, to stay visible but not purchasable,
                 or if you want to simply remove the countdown box.','ywpc'),'<b>','</b>'); ?>
            </p>
        </div>
        <div class="col-1">
    ...
    <div class="landing-container">
        ...
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e('Shortcode and widget','ywpc');?></h2>
            </div>
            <p>
                <?php
                ...
                Set one or more product IDs and that\'s all!','ywpc'),'<b>','</b>');
                ?>
            </p>
        </div>
    </div>
    ...
    <div class="landing-container">
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e('Tailored texts','ywpc');?></h2>
            </div>
            <p>
                <?php
                ...
                %1$scustomize the messages%2$s that the plugin show to users from the settings panel.','ywpc'),'<b>','</b>' );
                ?>
            </p>
        </div>
        <div class="col-1">
    ...
    <div class="landing-container">
        ...
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e('3 different layouts','ywpc');?></h2>
            </div>
            <p>
                <?php
                echo sprintf( __('Three different graphic styles for the countdown box of your shop products. Customize colors and use the instant preview to choose the %1$sperfect solution%2$s for your e-commerce.','ywpc'),'<b>','</b>');
                ?>
            </p>
        </div>
    </div>
    ...
    <div class="landing-container">
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e('Product groups','ywpc');?></h2>
            </div>
            <p>
                <?php
                echo sprintf( __('A comfortable solution that can make you spare precious time for your work.
                The plugin settings panel lets you configure %1&sdifferent countdowns for different product groups%2&s, without accessing to the product detail page.','ywpc'),'<b>','</b>' );
                ?>
            </p>
        </div>
        <div class="col-1">
    ...
    <div class="landing-container">
        ...
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e('"Top bar" or "bottom bar"?','ywpc');?></h2>
            </div>
            <p>
                <?php
                ...
                in all the pages of your site%2$s, and your users won\'t miss it!','ywpc'),'<b>','</b>' )
                ?>
            </p>
        </div>
    </div>
    ...
    <div class="landing-container">
        <div class="col-2">
            <div class="section-title">
                ...
                <h2><?php _e(' Pre-sale countdown','ywpc');?></h2>
            </div>
            <p>
                <?php
                ...
                to let your users know when the product will be available. Remeber to always inform them!','ywpc'),'<b>','</b>' );
                ?>
            </p>
        </div>
        <div class="col-1">
