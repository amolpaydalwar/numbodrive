...
$date = ywpc_get_countdown( $end_date );

?>
<div class="ywpc-countdown">
    <div class="ywpc-header">
        <?php
        echo apply_filters( 'ywpc_countdown_slogan', __( 'Countdown to sale', 'ywpc' ) );
        ?>
    </div>
