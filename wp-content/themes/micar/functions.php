<?php
/**
 * micar functions and definitions
 *
 * @version 1.0
 *
 * @date 12.08.2015
...
load_theme_textdomain( 'micar', get_template_directory() . '/languages' );
...
require_once( trailingslashit( get_template_directory() ). '/7upframe/controler/Polylang_Control.php' );
