...
<div class="list-product-group">
	<form class="cart" method="post" enctype='multipart/form-data'>
		<div class="table-group-detail table-responsive ">
			<table cellspacing="0" class="group_table table">
				<tbody>
					<tr>
						<th><span><?php echo esc_html__('PRODUCT NAME','micar');?></span></th>
						<th><span><?php echo esc_html__('price','micar');?></span></th>
						<th><span><?php echo esc_html__('Qty','micar');?></span></th>
					</tr>
					<?php
							...
							<tr id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
								<td class="group-thumb">
									<div class="product-thumb">
										<a href="<?php echo esc_url(get_the_permalink())?>" class="product-thumb-link"><?php echo get_the_post_thumbnail($grouped_product->get_id(),'full')?></a>
										<h3 class="product-title title14 text-uppercase"><a href="<?php echo esc_url(get_the_permalink())?>"><?php the_title()?></a></h3>
									</div>
								</td>
								<td class="group-info">
									<div class="product-info">
										...
										<?php
											echo apply_filters('s7upf_output_content',$grouped_product->get_price_html());
